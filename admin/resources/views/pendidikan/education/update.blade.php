...
@section('konten')
    <section class="container-fluid p-4">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <form id="formPendidikan" alamat="{{ route('pendidikan.educationUpdate') }}" data-parsley-validate method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2 align-items-center">
                                <label for="ket" class="col-sm-2 col-form-label">gambar1</label>
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <?php
                                            if($data->gambar1!=""){
                                                ...
                                                <div id="ed_priview3" class="col-md-12 mb-3 p-1 border" style="height:150px;">
                                                    <div  id="ed_pr_img3" style="background-repeat: no-repeat;background-position: left;background-size: contain;background-image:url('<?php echo asset('image')."/pendidikan"."/".$data->gambar1 ?>');width:100%;height:100%;">
                                                    </div>
                                                </div>
                                                <?php
                                            }else{
                                        ...
                                        <input class="form-control" type="file"  name="gambar1" id="gambar1"  <?= $gambar1?> >
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                          ...
                                          <?php
                                            if($data->gambar2!=""){
                                                ...
                                                <div id="ed_priview4" class="col-md-12 mb-3 p-1 border" style="height:150px;">
                                                    <div  id="ed_pr_img4" style="background-repeat: no-repeat;background-position: left;background-size: contain;background-image:url('<?php echo asset('image')."/pendidikan"."/".$data->gambar2 ?>');width:100%;height:100%;">
                                                    </div>
                                                </div>
                                                <?php
                                            }else{
                                        ...
                                        <input class="form-control" type="file"  name="gambar2" id="gambar2" <?= $gambar1?> >
                                    </div>
                                </div>
                            </div>
                        </div>
