...
@section('konten')
    <section class="container-fluid p-4">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <form id="formPendidikan" alamat="{{ route('pendidikan.modStore') }}" data-parsley-validate method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- {{ csrf_field() }} --}}
                    <div class="card">
                            ...
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="file"  name="gambarpendidikan" id="gambarpendidikan" required>
                                    </div>
                                </div>
                            </div>
                        </div>
