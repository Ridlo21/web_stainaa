...
@endsection
<?php
    $count = DB::table('bem')->where('status','aktif')->count();
?>
@section('konten')
    ...
    <div class="row">
        ...
        <div class="border-bottom pb-3 mb-3 d-flex align-items-center justify-content-between">
            ...
            <div>
                ...
                @else
                    <a href="{{route('kemahasiswaan.bemCreate')}}" class="btn btn-primary">New Bem</a>
                @endif
            </div>
        </div>
        </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownProjectOne">
                                                        ...
                                                        data="{{ $item->id_bem }}"
                                                        alamat="{{ route('kemahasiswaan.bemDestroy') }}">
...
<script>
    $(function () {
        $('#edit').on('click', function() {
                ...
                window.location.href = "{{ url('kemahasiswaanBemShow') }}/" + id
            })
