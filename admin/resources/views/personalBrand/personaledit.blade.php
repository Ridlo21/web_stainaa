...
@section('konten')
    <section class="container-fluid p-4">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <form id="formPersonalBrand" alamat="{{ route('personal.update') }}" data-parsley-validate method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" name="id" value="{{ $data->id_personal_branding }}">
                    <div class="card">
                        <div class="card-header pb-1 pt-2">
                            <h4 class="card-title">Edit Data Personal Branding</h4>
                        </div>
                        <div class="card-body">
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="title" name="title" required
                                        placeholder="Judul" value="{{ old('title', $data->title) }}">
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="context" id="context" cols="30" rows="5" required
                                        placeholder="Deskripsi">{{ old('context', $data->context) }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
