...
@endsection
<?php
    $count = DB::table('landing_akreditasi')->where('status','aktif')->count();
?>
@section('konten')
    ...
    <div class="row">
        ...
        <div class="border-bottom pb-3 mb-3 d-flex align-items-center justify-content-between">
            ...
            <div>
                ...
                @else
                <a href="{{route('akreditasi.modCreate')}}" class="btn btn-primary">New akreditsi</a>
                @endif
            </div>
        </div>
        </div>
            ...
            <div class="card">
                <div class="border-bottom p-4 d-flex flex-column gap-3">
                    <div class="d-flex flex-column gap-4">
                        <div class="col-lg-12">
                            <a href="{{ route('akreditsi.modCreate') }}" class="btn btn-sm btn-success">Tambah Data</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column ">
                                    <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="dropdown dropstart">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownProjectOne">
                                                        ...
                                                        data="{{ $item->id_landing_akreditasi }}">
                                                            <i class="fe fe-trash dropdown-item-icon"></i>
                                                            Edit
                                                        </button>
                                                        <button type="submit" id="btNonaktif" class="dropdown-item"
                                                        data="{{ $item->id_landing_akreditasi }}"
                                                        alamat="{{ route('akreditasi.modDestroy') }}">
                                                            <i class="fe fe-trash dropdown-item-icon"></i>
                                                            Hapus
                                                        </button>
                                                    </div>
                                        ...
                                        <div class="">
                                            <img src="{{asset('image')}}/akreditasi/{{ $item->gambar }}" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(function () {
        $('#edit').on('click', function() {
                ...
                window.location.href = "{{ url('akreditasiModShow') }}/" + id
            })
