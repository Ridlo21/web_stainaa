...
<?php
    $data = DB::table('landing_contact')->where('id_landing_contact', $id)->first();
?>
...
@section('konten')
    <section class="container-fluid p-4">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <form id="formcontact" alamat="{{ route('contact.modUpdate') }}" data-parsley-validate method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{$data->id_landing_contact}}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2 align-items-center">
                                <label for="noContact" class="col-sm-2 col-form-label">No Contact</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" required id="noContact" name="noContact"
                                        placeholder="No Contact" value="{{$data->no_contact}}">
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <label for="map" class="col-sm-2 col-form-label">Map</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" required id="map" name="map"
                                        placeholder="Map / Kordinat Wilayah" value="{{$data->map}}">
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                            ...
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" required name="deskripsi" id="context" cols="30" rows="5"
                                        placeholder="Deskripsi">{{$data->descripton}}</textarea>
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <?php
                                            if($data->gambar!=""){
                                                ...
                                                <div id="ed_priview3" class="col-md-12 mb-3 p-1 border" style="height:150px;">
                                                    <div  id="ed_pr_img3" style="background-repeat: no-repeat;background-position: left;background-size: contain;background-image:url('<?php echo asset('image')."/contact"."/".$data->gambar ?>');width:100%;height:100%;">
                                                    </div>
                                                </div>
                                                <?php
                                            }else{
                                        ...
                                        <input class="form-control" type="file"  name="gambarcontact" id="gambarcontact"  <?= $gambar?>>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            swal.fire({
                                ...
                                $('#spinnerWrapper').css('display', 'flex')
                                window.location.href = "{{ url('/contactModIndex') }}"
                            })
                        }
                    })
                }
