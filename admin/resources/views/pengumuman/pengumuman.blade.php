        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="pb-5 d-flex flex-column flex-lg-row gap-3 justify-content-between align-items-lg-center">
                    ...
                    <div>
                        <form action="{{ route('pengumuman.list') }}" method="GET">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#btTambah').on('click', function() {
                window.location.href = "{{ route('pengumuman.Add') }}"
            })

            $('.btEdit').on('click', function() {
                var id = $(this).attr('data')
                window.location.href = "{{ url('pengumumanEdit') }}/" + id
            })
            ...
            $('.btInfo').on('click', function() {
                var id = $(this).attr('data')
                window.location.href = "{{ url('pengumumanInfo') }}/" + id
            })
        })
    </script>
@endsection
