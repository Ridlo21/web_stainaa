            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div
                    ...
                    <div>
                        ...
                        <p>
                            {{ $data->dibaca .' x dibaca | ' .$data->hari .', ' .Carbon\Carbon::parse($data->tanggal)->locale('id')->translatedFormat('d F Y') .' ' .Carbon\Carbon::parse($data->jam)->locale('id')->translatedFormat('H:i') .' ' .'WIB | ' .'Penulis : ' .$data->penulis }}
                        </p>
                    </div>
                </div>
            </div>
