...
@endsection
<?php
    $data = DB::table('tentang_visi')->where('id_tentang_visi', $id)->first();
?>
@section('konten')
    <section class="container-fluid p-4">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <form id="formVisi" alamat="{{ route('tentang.visiUpdate') }}" data-parsley-validate method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="{{$data->id_tentang_visi}}">
                    @csrf
                    {{-- {{ csrf_field() }} --}}
                    <div class="card">
                            ...
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" required name="visi" id="context" cols="50" rows="5"
                                        placeholder="Visi Stainaa">{{$data->isi_visi}}</textarea>
                                </div>
                            </div>
                        </div>
