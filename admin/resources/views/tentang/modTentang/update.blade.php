...
<?php
    $data = DB::table('landing_tentang')->where('id_landing_tentang', $id)->first();
?>
...
@section('konten')
    <section class="container-fluid p-4">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <form id="formPersonalBrand" alamat="{{ route('tentang.modUpdate') }}" data-parsley-validate method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{$data->id_landing_tentang}}">
