    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            <div
                ...
                <div>
                    <h1 class="mb-0 h2 fw-bold">Tentang</h1>/mod
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="border-bottom p-4 d-flex flex-column gap-3">
                    <div class="d-flex flex-column gap-4">
                        <div class="col-lg-12">
                            <a href="{{ route('tentang.modCreate') }}" class="btn btn-sm btn-success">Tambah Data</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column ">
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="">
                                            <img src="{{asset('image')}}/tentang/{{ $item->gambar }}" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(function () {
        $('#edit').on('click', function() {
                ...
                window.location.href = "{{ url('tentangModShow') }}/" + id
            })
