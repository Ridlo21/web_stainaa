    ...
    <section class="container-fluid p-4">
            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div
                    ...
                    <div>
                        ...
                        <p>
                            {{ $data->dibaca .' x dibaca | ' .$data->hari .', ' .Carbon\Carbon::parse($data->tanggal)->locale('id')->translatedFormat('d F Y') .' ' .Carbon\Carbon::parse($data->jam)->locale('id')->translatedFormat('H:i') .' ' .'WIB | ' .'Penyusun : ' .$data->penulis .' | Foto : ' .$data->ket_gambar }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12 col-8">
                <div class="mb-3">
                    <img src="{{ asset('image') }}/artikel/{{ $data->gambar1 }}" alt="gambar 1" width="670">
                </div>
                {!! $data->isi_artikel !!}
                <div class="mt-3">
