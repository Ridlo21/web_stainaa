        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div class="pb-5 d-flex flex-column flex-lg-row gap-3 justify-content-between align-items-lg-center">
                    ...
                    <div>
                        <form action="{{ route('artikel.List') }}" method="GET">
                    ...
                    @foreach ($data as $item)
                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-12">
                            <div class="card h-100">
                                <img src="{{ asset('image') }}/artikel/{{ $item->gambar1 }}" class="card-img-top"
                                    alt="">
                                <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btEdit').on('click', function() {
                ...
                window.location.href = "{{ url('artikelEdit') }}/" + id
            })

            $('.btInfo').on('click', function() {
                var id = $(this).attr('data')
                window.location.href = "{{ url('artikelInfo') }}/" + id
            })
