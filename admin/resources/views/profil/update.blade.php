...
<?php
    $data = DB::table('profile_singkat')->where('id_profile', $id)->first();
?>
...
@section('konten')
    <section class="container-fluid p-4">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <div
                    ...
                    <div>
                        <h1 class="mb-0 h2 fw-bold">Profi</h1>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                <form id="formProfi" alamat="{{ route('profil.update') }}" data-parsley-validate method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" required name="deskripsi" id="context" cols="30" rows="5"
                                        placeholder="Deskripsi">{{$data->isi_profile}}</textarea>
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <?php
                                            if($data->gambar!=""){
                                                ...
                                                <div id="ed_priview3" class="col-md-12 mb-3 p-1 border" style="height:150px;">
                                                    <div  id="ed_pr_img3" style="background-repeat: no-repeat;background-position: left;background-size: contain;background-image:url('<?php echo asset('image')."/profil"."/".$data->gambar ?>');width:100%;height:100%;">
                                                    </div>
                                                </div>
                                                <?php
                                            }else{
                                        ...
                                        <input class="form-control" type="file"  name="gambarProfi" id="gambarProfi"  <?= $gambar?>>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $("#formProfi").on('submit', function(e) {
                e.preventDefault()
