...
@endsection
<?php
    $count = DB::table('profile_singkat')->where('status','aktif')->count();
?>
@section('konten')
    ...
    <div class="row">
        ...
        <div class="border-bottom pb-3 mb-3 d-flex align-items-center justify-content-between">
            ...
            <div>
                ...
                @else
                    <a href="{{route('profil.create')}}" class="btn btn-primary">New profil</a>
                @endif
            </div>
        </div>
        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-column ">
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="">
                                            <img src="{{asset('image')}}/profil/{{ $item->gambar }}" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(function () {
        $('#edit').on('click', function() {
                ...
                window.location.href = "{{ url('profilShow') }}/" + id
            })
