...
<body>
    <div class="preloader">
        <div class="preloader-text"><span class="preloader-char">l</span><span class="preloader-char">o</span><span
                class="preloader-char">a</span><span class="preloader-char">d</span><span
                class="preloader-char">i</span><span class="preloader-char">n</span><span
                class="preloader-char">g</span></div>
    </div>
    <div class="page">
        <!-- Page Header-->
                ...
                <div class="row row-10 justify-content-lg-between">
                    ...
                    <div class="col-md-6 col-lg-5">
                        ...
                        <div class="unit unit-horizontal unit-spacing-md align-items-center wow fadeInUp"
                            data-wow-delay=".1s">
                            <div class="unit-left"><img class="img-circle" src="dist/images/person-01-80x80.jpg" alt=""
                                    width="80" height="80" />
                            </div>
                            <div class="unit-body">
            ...
            <div class="container">
                ...
                <div class="owl-carousel owl-style-minimal" data-items="1" data-sm-items="2" data-lg-items="3"
                    ...
                    <blockquote class="quote-primary">
                        ...
                        <div class="quote-footer">
                            <div class="unit unit-horizontal unit-spacing-md align-items-center">
                                <div class="unit-left"><img class="img-circle" src="dist/images/person-01-64x64.jpg" alt=""
                                        width="64" height="64" />
                                </div>
                                <div class="unit-body">
                    ...
                    <blockquote class="quote-primary">
                        ...
                        <div class="quote-footer">
                            <div class="unit unit-horizontal unit-spacing-md align-items-center">
                                <div class="unit-left"><img class="img-circle" src="dist/images/person-02-64x64.jpg" alt=""
                                        width="64" height="64" />
                                </div>
                                <div class="unit-body">
                    ...
                    <blockquote class="quote-primary">
                        ...
                        <div class="quote-footer">
                            <div class="unit unit-horizontal unit-spacing-md align-items-center">
                                <div class="unit-left"><img class="img-circle" src="dist/images/person-03-64x64.jpg" alt=""
                                        width="64" height="64" />
                                </div>
                                <div class="unit-body">
                ...
                <div class="row row-20">
                    <div class="col-sm-6 col-md-4 col-xl-2 wow fadeInUp" data-wow-delay="0s">
                        <div class="link-image-wrap"><a class="link-image" href="#"><img
                                    src="dist/images/brand-01-180x80.png" alt="" width="180" height="80" /></a></div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-xl-2 wow fadeInUp" data-wow-delay=".1s">
                        <div class="link-image-wrap"><a class="link-image" href="#"><img
                                    src="dist/images/brand-02-180x80.png" alt="" width="180" height="80" /></a></div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-xl-2 wow fadeInUp" data-wow-delay=".2s">
                        <div class="link-image-wrap"><a class="link-image" href="#"><img
                                    src="dist/images/brand-03-180x80.png" alt="" width="180" height="80" /></a></div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-xl-2 wow fadeInUp" data-wow-delay=".3s">
                        <div class="link-image-wrap"><a class="link-image" href="#"><img
                                    src="dist/images/brand-04-180x80.png" alt="" width="180" height="80" /></a></div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-xl-2 wow fadeInUp" data-wow-delay=".4s">
                        <div class="link-image-wrap"><a class="link-image" href="#"><img
                                    src="dist/images/brand-05-180x80.png" alt="" width="180" height="80" /></a></div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-xl-2 wow fadeInUp" data-wow-delay=".5s">
                        <div class="link-image-wrap"><a class="link-image" href="#"><img
                                    src="dist/images/brand-06-180x80.png" alt="" width="180" height="80" /></a></div>
                    </div>
                </div>
            </div>
        </section>
